...
float printOnce = 1;
float FOV = 90.0f;                 //FOV - Field Of View
SDL_Event event = { 0 };
...
void createShapes() {
	...
	shapeVector.push_back(new Sphere(vec3(0, 5, -20), 4, vec3(1.0f, 0.0f, 1.0f)));//(0, 0, -20)
	shapeVector.push_back(new Sphere(vec3(5, -1, -15), 2, vec3(0.149, 0.141, 0.912)));//Lilac
	shapeVector.push_back(new Sphere(vec3(15, 2, -25), 3, vec3(0.0f, 0.5f, 1.0f)));//forest green  (5, 0, -25)
	shapeVector.push_back(new Sphere(vec3(-5.5f, 0, -15), 3, vec3(0.5f)));//(-5.5f, 0, -15)
	shapeVector.push_back(new Sphere(vec3(0, -1, -5), 1, vec3(0.297, 1.000, 0.650)));
	// shapeVector.push_back(new Sphere(vec3(0, -1, -5), 1, vec3(0.297, 1.000, 0.650)));
...
int main(int argc, char* args[]) {
	...
	window = SDL_CreateWindow("| EXCALIBUR |", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, width, height, SDL_WINDOW_SHOWN);
